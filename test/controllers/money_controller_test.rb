...
class MoneyControllerTest < ActionController::TestCase
  ...
  test "should create money" do
    assert_difference('Money.count') do
      post :create, money: { balance: @money.balance, deposits: @money.deposits, withdrawals: @money.withdrawals }
    end
  ...
  test "should update money" do
    patch :update, id: @money, money: { balance: @money.balance, deposits: @money.deposits, withdrawals: @money.withdrawals }
    assert_redirected_to money_path(assigns(:money))
  end
